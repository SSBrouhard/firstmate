...
FM_BACKEND=             # optional runtime session-provider backend override for new spawns; tmux (reference) or herdr (experimental); codex-app is ledger-only and rejected for spawns
