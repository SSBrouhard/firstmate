...
tests/fm-x-mode.test.sh                   # X-mode poll, inbox context round-trip, reply threading, image attachments, dismiss, dry-run preview, and .env-presence activation tests
